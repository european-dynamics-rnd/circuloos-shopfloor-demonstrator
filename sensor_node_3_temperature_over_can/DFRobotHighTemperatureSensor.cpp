...
int DFRobotHighTemperature::readTemperature(int PIN)     //Get temperature
{
    ...
    voltage = sensorValue * _voltageRef / 4096.0;  //If your microcontroller are a 12 bit ADC, you should be change 1024 to 4096
	...
	res =  (1800 * voltage + 195.0 * 18) / (2.209 * 18 - voltage);
